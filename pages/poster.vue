<template>
  <div class="card">
    <b-card-group deck>
      ...
      >
        <b-card-text>
          Um menino acaba descobrindo uma conferência de bruxas enquanto fica
          com a avó em um hotel e é transformado em rato pela Grande Bruxa.<br />
      ...
      >
        <b-card-text>
          Depois de trocar de corpo com um assassino em série, a adolescente de
          colegial Millie descobre que tem menos de um dia para reverter a
          situação antes que seja tarde demais.
        </b-card-text>
        <template v-slot:footer>
          <b-button class="botao" variant="Primary"
            ><NuxtLink to="/freaky">Ver mais</NuxtLink>
          </b-button>
        </template>
      </b-card>
      ...
      >
        <b-card-text>
          Armado com apenas uma palavra 'Tenet' e lutando pela sobrevivência do
          mundo inteiro, o Protagonista viaja através de um mundo crepuscular de
          espionagem internacional em uma missão que irá desenrolar em algo para
          além do tempo real.
        </b-card-text>
        <template v-slot:footer>
          <b-button class="botao" variant="Primary"
            ><NuxtLink to="/tenet">Ver mais </NuxtLink></b-button
          >
        </template>
      </b-card>
      <b-card
      ...
      >
        <b-card-text>
          Cinco jovens mutantes descobrem o alcance de seus poderes e lidam com
          traumas do passado enquanto são mantidos presos contra a vontade num
          sinistro hospitla.
        </b-card-text>
        <template v-slot:footer>
          <b-button class="botao" variant="Primary"
            ><NuxtLink to="/the_new_mutants">Ver mais </NuxtLink>
          </b-button>
        </template>
      </b-card>
    </b-card-group>
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "os proximos filmes em cartaz no cinemac, não perca os lançamentos, vem pro cinemac",
        },
      ],
    };
  },
